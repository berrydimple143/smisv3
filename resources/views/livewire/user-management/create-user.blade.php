<div wire:ignore.self class="modal fade" id="addUserModal" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-success modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="formModalLabel">User Creator</h5>
                ...
                <form>                    
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input wire:model.lazy="email" type="text" class="form-control @if($errors->has('email')) is-invalid @endif" required>
