<div wire:ignore.self class="modal fade" id="addSubjectActivityModal" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-success modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="formModalLabel">Subject Activity Creator</h5>
            ...
            <div class="modal-body">
                ...
                <form>                    
                    <input wire:model="subject_id" type="hidden" id="subject_id" value="{{ $subject->id }}">
                    <input wire:model="section_id" type="hidden" id="section_id" value="{{ $section->id }}">
                    <div class="form-row">
