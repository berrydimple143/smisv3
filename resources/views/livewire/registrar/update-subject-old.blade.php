<div wire:ignore.self class="modal fade" id="editSubjectModal" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-success modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="formModalLabel">Subject Editor</h5>
                ...
                <form>                    
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select wire:model.lazy="classification" class="form-control" disabled>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select wire:model.lazy="course_id" class="form-control" disabled>  
                            @if(!empty($classification))
                                @foreach($listOflevels as $crs)
