<div wire:ignore.self class="modal fade" id="addStudentModal" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-success modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="formModalLabel">Student Details</h5>
                ...
                <form wire:submit.prevent="submit">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input wire:model="current_address" wire:change="checkAddressValue($event.target.id)" type="text" id="current" class="form-control @if($errors->has('current_address')) is-invalid @endif" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input wire:model="permanent_address" wire:change="checkAddressValue($event.target.id)" type="text" id="permanent" class="form-control @if($errors->has('permanent_address')) is-invalid @endif" required>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-12">
                            <div class="form-inline">
                                <label>Complete Address: </label>&nbsp;&nbsp;&nbsp;
                                <input wire:model="sameAsFatherAddress" wire:click="$emit('addressClicked')" class="form-check-input" type="checkbox" id="sameAsFatherAddress">
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-12">
                            <div class="form-inline">
                                  ...
                                  <input wire:model="fatherDetails" wire:change="changeGuardianDetails($event.target.value)" id="fatherD" name="fatherDetails" type="radio" value="father" class="form-check-input">
                                  <label class="form-check-label" for="fatherD">Same as father details</label>&nbsp;&nbsp;&nbsp;
                                  <input wire:model="fatherDetails" wire:change="changeGuardianDetails($event.target.value)" id="motherD" name="fatherDetails" type="radio" value="mother" class="form-check-input">
            ...
            <div class="modal-footer">
                <button wire:click="$emit('resetInputs')" type="button" class="btn btn-secondary wire:click.prevent="resetInputs" close-btn" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-success" wire:click.prevent="resetInputs">Reset</button>
                <button class="btn btn-primary close-modal px-5" wire:click.prevent="store" wire:loading.attr="disabled" @click="scrollTo({top: 0, behavior: 'smooth'})"><div wire:loading wire:target="store"><span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span></div> Add Now</button>
            </div>
        </div>
    </div>
</div>
