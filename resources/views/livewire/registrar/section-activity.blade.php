<div class="container-fluid">
    <div class="row">
        <div class="col">       
        	@include('livewire.registrar.create-section-activity') 	
        	@include('livewire.registrar.update-section-activity')

            <div class="card card-accent-success">	
            	<div class="card-header">List of activities for section "{{ $sectionName }}"
