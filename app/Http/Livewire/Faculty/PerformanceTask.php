...
class PerformanceTask extends Component
{
    ...
    {
        return view('livewire.faculty.performance-task', [
            'tasks' => SubjectCriteria::where('course_id', $this->course_id)->where('subject_id', $this->subject_id)->where('criteria_id', $this->criteria_id)
